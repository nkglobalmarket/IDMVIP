...
cls
color 07
title  IDM Activation NK GLOBAL %iasver%
...
%eline%
echo You are running outdated version %iasver%
echo ________________________________________________
echo:
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/nkglobalmarket/IDMVIP & start %mas%/idm-activation-script & exit /b)
)
)
...
echo:                                                               
echo:               [1] Aktif et
echo:               [2] Deneme dondur
echo:               [3] Aktivasyon sıfırlar / Trial
echo:               _____________________________________________   
echo:                                                               
echo:               [4] güncellenecek IDM
echo:               [5] Yardım
echo:               [0] Cıkıs
echo:            ___________________________________________________
echo:         
...
if %_erl%==6 exit /b
if %_erl%==5 start https://github.com/nkglobalmarket/IDMVIPt & start https://github.com/nkglobalmarket/IDMVIP & goto MainMenu
...
echo %line%
echo:
call :_color %Green% "The IDM sıfırlama tamamlandı."
...
echo %line%
echo:
echo      Etkinleştirme bazı kullanıcılar için çalışmıyor ve IDM sahte seri uyarı ekranı gösterebilir.
echo:
call :_color2 %_White% "     " %_Green% "Bunun yerine Denemeyi Dondur seçeneğini kullanmanız önerilir."
echo %line%
echo:
choice /C:19 /N /M ">    [1] Geri [9] devam et : "
...
echo:
if %frz%==0 (
call :_color %Green% "IDM Aktivasyon işlemi tamamlandı."
echo:
call :_color %Gray% "Sahte seri ekranı görüntülenirse bunun yerine Denemeyi Dondur seçeneğini kullanın."
) else (
call :_color %Green% "IDM 30 günlük deneme süresi Ömür Boyu başarıyla donduruldu."
echo:
call :_color %Gray% "IDM kaydolmak için bir açılır pencere gösteriyorsa IDM'yi yeniden yükleyin."
)
...
if defined terminal (
call :_color %_Yellow% "Geri dönmek için 0 tuşuna basın..."
choice /c 0 /n
) else (
call :_color %_Yellow% "Geri dönmek için herhangi bir tuşa basın..."
pause %nul1%
)
goto MainMenu
...
echo:
echo Belirli kayıt defteri anahtarlarını oluşturmak için birkaç indirme tetikleniyor, lütfen bekleyin...
echo:
...
echo:
echo Kayıt defteri anahtar ekleniyor...
echo:
